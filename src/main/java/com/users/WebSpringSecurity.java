...
public class WebSpringSecurity extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	public WebSpringSecurity(Environment environment,
	...
	// lets the filters ignore the /auth/signup and check so that people are able to register
	@Override
	public void configure(WebSecurity web) throws Exception {
		web.ignoring().antMatchers("/auth/signup").antMatchers("/auth");
	}
